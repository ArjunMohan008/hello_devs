...
router.put(
  ...
  [
    auth,
    [
      check('title', 'Title is requird')
        .not()
        .isEmpty(),
      check('company', 'Company is requird')
        .not()
        .isEmpty(),
      check('from', 'From date is requird')
        .not()
        .isEmpty()
    ]
  ],
  async (req, res) => {
    ...
    try {
      ...
      profile.experience.unshift(newWxp);
...
// @des         Delete experience in profile
// @accress     private
...
router.put(
  ...
  [
    auth,
    [
      check('school', 'School is requird')
        .not()
        .isEmpty(),
      check('degree', 'Degree is requird')
        .not()
        .isEmpty(),
      check('fieldofstudy', 'Field of study is requird')
        .not()
        .isEmpty(),
      check('from', 'From date is requird')
        .not()
...
// @des         Delete education in profile
// @accress     private
